...
local on_attach = function(client, bufnr)
  ...
  keymap.set("n", "cd", "<cmd>Lspsaga show_line_diagnostics<CR>", opts) -- show  diagnostics for line
  keymap.set("n", "cd", "<cmd>Lspsaga show_cursor_diagnostics<CR>", opts) -- show diagnostics for cursor
  ...
  keymap.set("n", "t", "<cmd>Lspsaga hover_doc<CR>", opts) -- show documentation for what is under cursor
  keymap.set("n", "<C-o>", "<cmd>LSoutlineToggle<CR>", opts) -- see outline on right hand side
  -- inlay-hints
